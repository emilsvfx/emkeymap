...
def _template_items_basic_tools(*, connected=False):
    return [
        ...
        op_tool("builtin.move", {"type": 'T', "value": 'PRESS'}),
        op_tool("builtin.rotate", {"type": 'R', "value": 'PRESS'}),
        op_tool("builtin.scale", {"type": 'E', "value": 'PRESS'}),
...
def km_window(params):
    ...
    items.extend([
        ...
        ("wm.context_menu_enum", {"type": 'W', "value": 'PRESS', "alt": True, "repeat": True},
         {"properties": [("data_path", 'object.display_type')]}),
        ("wm.context_toggle", {"type": 'ACCENT_GRAVE', "value": 'PRESS', "repeat": True},
...
def km_sequencer(params):
    ...
    items.extend([
        ...
        *_template_items_context_menu("SEQUENCER_MT_context_menu", {"type": 'RIGHTMOUSE', "value": 'PRESS'}),
        ...
        # Tools
        op_tool("builtin.select_box", {"type": 'Q', "value": 'PRESS'}),
        op_tool("builtin.blade", {"type": 'B', "value": 'PRESS'}),
    ])
...
def km_grease_pencil_stroke_edit_mode(params):
    ...
    items.extend([
        ...
        *_template_items_basic_tools(),
        ...
        op_tool("builtin.radius", {"type": 'R', "value": 'PRESS', "ctrl": True}),
        op_tool("builtin.bend", {"type": 'B', "value": 'PRESS', "ctrl": True}),
    ])
...
def km_pose(params):
    ...
    items.extend([
        *_template_items_animation(),
        ...
        ("pose.loc_clear", {"type": 'T', "value": 'PRESS', "alt": True}, None),
...
def km_object_mode(params):
    ...
    items.extend([
        *_template_items_animation(),
        ...
        ("object.location_clear", {"type": 'T', "value": 'PRESS', "alt": True},
         {"properties": [("clear_delta", False)]}),
        ("object.rotation_clear", {"type": 'R', "value": 'PRESS', "alt": True},
         {"properties": [("clear_delta", False)]}),
        ("object.scale_clear", {"type": 'E', "value": 'PRESS', "alt": True},
         {"properties": [("clear_delta", False)]}),
...
def km_mesh(params):
    ...
    items.extend([
        ...
        ("mesh.loopcut_slide", {"type": 'C', "value": 'PRESS', "alt": True, "repeat": True}, None),
        ("mesh.vert_connect_path", {"type": 'J', "value": 'PRESS', "repeat": True}, None),
        ("mesh.dupli_extrude_cursor", {"type": 'RIGHTMOUSE', "value": 'PRESS', "ctrl": True}, None),
